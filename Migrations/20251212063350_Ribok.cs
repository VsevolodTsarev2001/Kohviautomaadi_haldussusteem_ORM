...
{
    /// <inheritdoc />
    public partial class Ribok : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JoogiNimi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Kogus = table.Column<int>(type: "int", nullable: false),
                    TopsiTüüp = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaksimisViis = table.Column<string>(type: "nvarchar(max)", nullable: false),
